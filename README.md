...
This project provides a simple Python-based Stratum server designed for **home miners**, **experimentation**, and **sidechain developers** running a Drivechain-patched Bitcoin node (BIP300/301).
